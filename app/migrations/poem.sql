...
insert into poems (content,poet)
values
...
('人生如梦 一尊还酹江月','苏轼'),
('春色三分 二分尘土 一分流水 细看来 不是杨花 点点是 离人泪','苏轼'),
('花自飘零水自流 一种相思 两处闲愁 此情无计可消除 才下眉头 却上心头','李清照'),
('梧桐更兼细雨 到黄昏 点点滴滴 这次第 怎一个 愁字了得','李清照'),
('月上柳梢头 人约黄昏后','朱淑真'),
...
('人生若只如初见 何事秋风悲画扇','安意如'),
('来我怀里 或者 让我住进你的心里 默然相爱 寂静喜欢','仓央嘉措'),
('最佳的报复不是仇恨 而是打心底发出的冷淡 干嘛花力气去恨一个不相干的人','舒婷'),
('生命从来不是公平的 得到多少 便要靠那个多少做到最好 努力的生活下去','舒婷'),
('一个人走不开 不过因为他不想走开 一个人失约 乃因他不想赴约 一切借口均属废话 都是用以掩饰不愿牺牲','舒婷'),
('当我痛苦地站在你的面前 你不能说我一无所有 你不能说我两手空空','海子'),
('今天 我什么也不说 让别人去说','海子'),
('黑夜一无所有 为何给我安慰','海子'),
('你一会看我 一会看云 我觉得你看我时很远 你看云时很近','顾城'),
...
('其实 每个人都是幸福的 只是你的幸福常常在别人眼里',''),
('黛玉笑道:"偏是咬舌子爱说话,连个‘二’哥哥也叫不出来, 只是‘爱‘哥哥’爱‘哥哥的.回来赶围棋儿,又该你闹’幺爱三四五‘了.','红楼梦'),
('每日家情思睡昏昏','林黛玉'),
('黛玉道：“别理他，你先给 我舀水去罢。”紫鹃笑道：“他是客，自然先倒了茶来再舀水去。”说着倒茶去了。宝玉笑道：“好丫头，‘若共你多情小姐同鸳帐，怎舍得叠被铺床？’”','红楼梦')
;
