<button id="db-update" class="btn btn-danger" type="button">Update Database</button>
<button id="lyric-update" class="btn btn-danger" type="button">Update Lyrics</button>
<button id="pinyin-update" class="btn btn-danger" type="button">Update Pinyin</button>
...
<script>
	$("#db-update").click( function () {
		...
		$("#update-data").empty();
        $("#update-data").append("<img src='/assets/img/ajax.gif'>");
